...
OBJECTS = $(OBJ_FOLDER)/my_time_lib.o $(OBJ_FOLDER)/cpu_sequential.o $(OBJ_FOLDER)/cpu_simd.o $(OBJ_FOLDER)/cpu_simd_parallel_dp.o $(OBJ_FOLDER)/cpu_simd_parallel_node.o $(OBJ_FOLDER)/cuda_naive.o $(OBJ_FOLDER)/cuda_parallel_node.o $(OBJ_FOLDER)/cuda_parallel_async.o $(OBJ_FOLDER)/cuda_async_monolithic.o $(OBJ_FOLDER)/cuda_async_batching.o $(OBJ_FOLDER)/cuda_shared_mem.o $(OBJ_FOLDER)/hybrid_base.o $(OBJ_FOLDER)/hybrid_unified.o $(OBJ_FOLDER)/hybrid_pinned.o
